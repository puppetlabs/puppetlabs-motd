...
group :system_tests do
  ...
  gem "puppet_litmus",                                require: false, git: 'https://github.com/puppetlabs/puppet_litmus.git', platforms: [:ruby, :mswin, :mingw, :x64_mingw] if ENV['PUPPET_GEM_VERSION'].nil? or ENV['PUPPET_GEM_VERSION'] !~ %r{ 5}
