...
group :development do
  ...
  gem "puppet_litmus",                                           require: true, git: 'https://github.com/sanfrancrisko/puppet_litmus', ref: 'feat/main/puppet_spec_test_matrix' if Gem::Version.new(RUBY_VERSION.dup) >= Gem::Version.new('2.5.0')
end
