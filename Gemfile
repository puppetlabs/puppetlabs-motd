...
group :development do
  ...
  gem "bolt", '2.33.1',                                          require: false if Gem::Version.new(RUBY_VERSION.dup) >= Gem::Version.new('2.5.0')
  gem "rspec-puppet",                                            require: false, git: 'https://github.com/DavidS/rspec-puppet', ref: 'raise_error'
end
