...
group :system_tests do
  gem "puppet_litmus", git: "https://github.com/puppetlabs/puppet_litmus.git", branch: "MAINT-Fix_failing_GCP_installations", require: false, platforms: [:ruby, :x64_mingw] if !ENV['PUPPET_FORGE_TOKEN'].to_s.empty?
